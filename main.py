...
class formwindow(QtWidgets.QMainWindow):
    ...
    def start_sending(self):
        ...
        if token == '':
            ...
            self.mainui.logs_text.append('Программа запущенна! Не закрывать!')
    ...
    def show_slash(self):
        if self.mainui.slash_Button.text() == '':
            ...
            self.mainui.delay.setGeometry(QtCore.QRect(817, 637, 45, 22))
            ...
            self.mainui.delay.setGeometry(QtCore.QRect(817, 448, 45, 22))
